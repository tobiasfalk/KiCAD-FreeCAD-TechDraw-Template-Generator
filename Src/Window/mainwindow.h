...
private:
    ...
    QList<SheetSize> SHEETSIZES = QList<SheetSize>   {
                                                    ...
                                                    SheetSize{"2048A0(2kA0)",            53824, 38048},
                                                    SheetSize{"1024A0(1kA0)",            38048, 26912},
                                                    SheetSize{"512A0",                   26912, 19024},
                                                    SheetSize{"256A0",                   19024, 13456},
                                                    SheetSize{"128A0",                   13456, 9512},
                                                    SheetSize{"64A0",                    9512,  6728},
                                                    SheetSize{"32A0",                    6728,  4756},
                                                    SheetSize{"16A0",                    4756,  3364},
                                                    SheetSize{"8A0",                     3364,  2378},
