...
class StandardDraw:
    ...
    def drawISO5457_ISO700_A(self):
        ...
        if self.SMALL_PARTS_LIST:
            ...
            # Horizontal
            dwg.line(start=(width - 190, height - 70 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)), end=(width - 10, height - 70- (self.SMALL_PARTS_LIST_NUM_LINES * 11)), linewidth = 0.35, color = color, group = "titleblock-structure")
            
            hPos = height - 75 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)
            ...
            hPos = height - 70 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)
            ...
            # Vertical
            dwg.line(start=(width - 175, height - 75 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)), end=(width - 175, height - 65), linewidth = 0.35, color = color, group = "titleblock-structure")
            dwg.line(start=(width - 155, height - 75 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)), end=(width - 155, height - 65), linewidth = 0.35, color = color, group = "titleblock-structure")
            dwg.line(start=(width - 140, height - 75 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)), end=(width - 140, height - 65), linewidth = 0.35, color = color, group = "titleblock-structure")
            dwg.line(start=(width - 80, height - 75 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)), end=(width - 80, height - 65), linewidth = 0.35, color = color, group = "titleblock-structure")
            dwg.line(start=(width - 45, height - 75 - (self.SMALL_PARTS_LIST_NUM_LINES * 11)), end=(width - 45, height - 65), linewidth = 0.35, color = color, group = "titleblock-structure")
    ...
    def drawISO5457_ISO700_B(self):
        ...
        dwg.text(text = '%S/%N', position = (width - 35 + 0.9, height - 21 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = 'EN', position = (width - 50 + 0.9, height - 21 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%R', position = (width - 50 + 0.9, height - 32 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%D', position = (width - 35 + 0.9, height - 32 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%C6', position = (width - 50 + 0.9, height - 43 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%T', position = (width - 110 + 0.9, height - 43 + 1.8 + 0.9 + 4.5), tsize = 5, linewidth = 0.35, color = color, heightAnchor = 'top', widthAnchor = 'start', group = "titleblock-text-editable")
        dwg.text(text = '', position = (width - 110 + 0.9, height - 43 + 1.8 + 0.9 + 4.5 + 7.5), tsize = 5, linewidth = 0.35, color = color, heightAnchor = 'top', widthAnchor = 'start', group = "titleblock-text-editable")
        dwg.text(text = '', position = (width - 110 + 0.9, height - 43 + 1.8 + 0.9 + 4.5 + 7.5 + 7.5), tsize = 5, linewidth = 0.35, color = color, heightAnchor = 'top', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%Y', position = (width - 190 + 0.9, height - 43 + 1.8 + 0.9 + 4.5), tsize = 5, linewidth = 0.35, color = color, heightAnchor = 'top', widthAnchor = 'start', group = "titleblock-text-editable")
        dwg.text(text = '', position = (width - 190 + 0.9, height - 43 + 1.8 + 0.9 + 4.5 + 7.5), tsize = 5, linewidth = 0.35, color = color, heightAnchor = 'top', widthAnchor = 'start', group = "titleblock-text-editable")
        dwg.text(text = '', position = (width - 190 + 0.9, height - 43 + 1.8 + 0.9 + 4.5 + 7.5 + 7.5), tsize = 5, linewidth = 0.35, color = color, heightAnchor = 'top', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%C1', position = (width - 190 + 0.9, height - 54 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%C3', position = (width - 110 + 0.9, height - 54 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%C5', position = (width - 50 + 0.9, height - 54 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%C0', position = (width - 190 + 0.9, height - 65 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%C2', position = (width - 110 + 0.9, height - 65 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        dwg.text(text = '%C4', position = (width - 50 + 0.9, height - 65 + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        for i in range(self.NUM_OPT_LINES):
            dwg.line(start=(width - 10, height - 65 - (11 * i)), end=(width - 190, height - 65 - (11 * i)), linewidth = 0.35, color = color, group = "titleblock-structure")
            if i == 0:
                dwg.text(text = 'A', position = (width - 190 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'B', position = (width - 190 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Raw dimensions', position = (width - 110 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'C', position = (width - 110 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Scale', position = (width - 50 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = '1:1', position = (width - 50 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
            elif i == 1:
                dwg.text(text = 'Surface treatment', position = (width - 190 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Surface treatment', position = (width - 190 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Weight', position = (width - 110 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Weight', position = (width - 110 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Standard', position = (width - 50 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Standard', position = (width - 50 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
            elif i == 2:
                dwg.text(text = 'Option X', position = (width - 190 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Option X', position = (width - 190 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Option Y', position = (width - 110 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Option Y', position = (width - 110 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Option Z', position = (width - 50 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
                dwg.text(text = 'Option Z', position = (width - 50 + 0.9, height - 65 - (11 * (i + 1)) + 1.8 + 0.9 + 4.75), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'start', widthAnchor = 'start', group = "titleblock-text-editable")
        ...
        if self.REV_HISTORY:
            ...
            for i in range(self.NUMREVISIONS):
                dwg.line(start=(width-190, 20 + (i * 15)), end=(width-10, 20 + (i * 15)), linewidth = 0.35, color = color, group = "sheet-border")
                dwg.text(text = 'ZoneA', position = (width - 182.5, 17.75 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Rev.A', position = (width - 165, 17.75 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'DescriptionA', position = (width - 107.5, 17.75 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'DateA', position = (width - 50, 17.75 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Created byA', position = (width - 25, 17.75 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'ZoneB', position = (width - 182.5, 13 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Rev.B', position = (width - 165, 13 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'DescriptionB', position = (width - 107.5, 13 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'DateB', position = (width - 50, 13 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Created byB', position = (width - 25, 13 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'ZoneC', position = (width - 182.5, 8.25 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Rev.C', position = (width - 165, 8.25 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'DescriptionC', position = (width - 107.5, 8.25 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'DateC', position = (width - 50, 8.25 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Created byC', position = (width - 25, 8.25 + ((i + 1) * 15)), tsize = 1.8, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
        ...
        if self.FULL_PARTS_LIST:
            ...
            for h in range(numLines):
                ...
                if not self.FULL_PARTS_LIST_SMALL_LINES:
                    dwg.text(text = 'Pos.' + str(h) + 'A', position = (27.5, hPos + 1.8 + 0.9 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Qty.' + str(h) + 'A', position = (45, hPos + 1.8 + 0.9 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Unit' + str(h) + 'A', position = (62.5, hPos + 1.8 + 0.9 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Titel' + str(h) + 'A', position = (100, hPos + 1.8 + 0.9 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Doc. number' + str(h) + 'A', position = (147.5, hPos + 1.8 + 0.9 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Comment' + str(h) + 'A', position = (182.5, hPos + 1.8 + 0.9 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                
                    dwg.text(text = 'Pos.' + str(h) + 'B', position = (27.5, hPos + 9.65 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Qty.' + str(h) + 'B', position = (45, hPos + 9.65 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Unit' + str(h) + 'B', position = (62.5, hPos + 9.65 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Titel' + str(h) + 'B', position = (100, hPos + 9.65 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Doc. number' + str(h) + 'B', position = (147.5, hPos + 9.65 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Comment' + str(h) + 'B', position = (182.5, hPos + 9.65 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    
                    dwg.text(text = 'Pos.' + str(h) + 'C', position = (27.5, hPos + 16.3 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Qty.' + str(h) + 'C', position = (45, hPos + 16.3 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Unit' + str(h) + 'C', position = (62.5, hPos + 16.3 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Titel' + str(h) + 'C', position = (100, hPos + 16.3 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Doc. number' + str(h) + 'C', position = (147.5, hPos + 16.3 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Comment' + str(h) + 'C', position = (182.5, hPos + 16.3 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                else:
                    dwg.text(text = 'Pos.' + str(h) + 'A', position = (27.5, hPos + 5 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Qty.' + str(h) + 'A', position = (45, hPos + 5 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Unit' + str(h) + 'A', position = (62.5, hPos + 5 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Titel' + str(h) + 'A', position = (100, hPos + 5 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Doc. number' + str(h) + 'A', position = (147.5, hPos + 5 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                    dwg.text(text = 'Comment' + str(h) + 'A', position = (182.5, hPos + 5 - lineHeight), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
        ...
        if self.SMALL_PARTS_LIST:
            ...
            for h in range(self.SMALL_PARTS_LIST_NUM_LINES):
                ...
                dwg.text(text = 'Pos.' + str(h) + 'A', position = (width - 182.5, hPos + 5.5), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Qty.' + str(h) + 'A', position = (width - 165, hPos + 5.5), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Unit' + str(h) + 'A', position = (width - 147.5, hPos + 5.5), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Titel' + str(h) + 'A', position = (width - 110, hPos + 5.5), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Doc. number' + str(h) + 'A', position = (width - 62.5, hPos + 5.5), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
                dwg.text(text = 'Comment' + str(h) + 'A', position = (width - 27.5, hPos + 5.5), tsize = 2.5, linewidth = 0.35, color = color, heightAnchor = 'middle', widthAnchor = 'middle', group = "titleblock-text-editable")
