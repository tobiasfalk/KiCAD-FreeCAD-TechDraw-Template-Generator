...
class UniversalDraw:
    ...
    def __init__(self, size = (100, 100), filename = 'export'):
        ...
        self.KICAD = KiCAD5Template(filename = filename + '.kicad_wks', size = size, linewidth = 0.35, left_margin = 0, right_margin = 0, top_margin = 0, bottom_margin = 0)  # No margins so that the 0 is at the same point as the others
    ...
    def line(self, start=(0, 0), end=(10, 0), linewidth = 0.15, color = '#000000', group = "nogroupe"):
        self.KICAD.line(start = start, end = end, linewidth = linewidth);
    ...
    def rect(self, start=(0, 0), end=(0, 0), linewidth = 0.15, color = '#000000', group = "nogroupe"):
        self.KICAD.rect(start = start, end = end, linewidth = linewidth)
    ...
    def polygon(self, position = (0, 0), linewidth = 0, points = [(0, 0), (10, 0), (10, 5), (5, 5), (5, 10), (0, 10), (0, 0)], color = '#000000', fill = 'none', group = "nogroupe"):
        ...
        self.KICAD.polygon(position = (0, 0), rotation = 0, linewidth = linewidth, points = points_offset)
    ...
    def text(self, text = "Dummy text", position = (0, 0), tsize = 0, linewidth = 0.15, color = '#000000', heightAnchor = 'start', widthAnchor = 'start', group = "nogroupe"):
        ...
        if text != '%D':
            self.KICAD.text(text = text, position = (position[0] - 0.3, position[1]), size = (tsize - 0.5, tsize - 0.5), linewidth = linewidth, heightAnchor = heightAnchor, widthAnchor = widthAnchor)
        else:
            self.KICAD.text(text = text, position = (position[0] - 0.3, position[1]), size = (tsize - 1, tsize - 1), linewidth = linewidth, heightAnchor = heightAnchor, widthAnchor = widthAnchor)
