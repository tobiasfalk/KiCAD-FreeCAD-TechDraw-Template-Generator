...
bool TemplateGenKiCAD_6::getLOGO() const
{
    return LOGO;
}

void TemplateGenKiCAD_6::setLOGO(bool newLOGO)
{
    LOGO = newLOGO;
    finisheD.logO = true;
}

const QString &TemplateGenKiCAD_6::getLOGODIR() const
{
    return LOGODIR;
}

void TemplateGenKiCAD_6::setLOGODIR(const QString &newLOGODIR)
{
    LOGODIR = newLOGODIR;
    finisheD.logodiR = true;
}

const QString &TemplateGenKiCAD_6::getSHEETNAME() const
{
    return SHEETNAME;
}

void TemplateGenKiCAD_6::setSHEETNAME(const QString &newSHEETNAME)
{
    SHEETNAME = newSHEETNAME;
    finisheD.sheetnamE = true;
}

bool TemplateGenKiCAD_6::init()
{
...
QString TemplateGenKiCAD_6::createFileName()
{
...
void TemplateGenKiCAD_6::drawLine(Coordinate start, Coordinate end, double lineWidth)
{
...
void TemplateGenKiCAD_6::drawRect(Coordinate start, Coordinate end, double lineWidth)
{
...
void TemplateGenKiCAD_6::drawPoly(Coordinate position, double rotaition, QList<Coordinate> points, double lineWidth)
{
...
qint64 TemplateGenKiCAD_6::drawText(Coordinate position, QString text, double textSize, TextHeightAnchor textHeightAnchor, TextWidthAnchor textWidthAnchor, double lineWidth, qint64 line)
{
    if(line > -1)
    {
...
qint64 TemplateGenKiCAD_6::drawText(Coordinate position, QStringList text, double textSize, TextHeightAnchor textHeightAnchor, TextWidthAnchor textWidthAnchor, double lineWidth, qint64 index)
{
    qint64 ret = 0;
    if(text.length() == 1)
    {
...
void TemplateGenKiCAD_6::drawVerFoldLine(double x, double depth)
{
...
void TemplateGenKiCAD_6::drawHorFoldLine(double y, double depth)
{
...
void TemplateGenKiCAD_6::drawTrimmingMarksISO5457()
{
...
void TemplateGenKiCAD_6::drawDrawingBorderISO5457()
{
    ...
    // Top and Bottom Framegrid
    {
        ...
        while(lineX < PAGESIZE.width - spaceRight)
        {
            ...
            {
                drawText(Coordinate{lineX + 25, PAGESIZE.height - 7.5}, PAGESIZE.sizeString.replace("_", " "), 3.5, TextHeightAnchor::Middle, TextWidthAnchor::Center, 0.35);
            }
            else if(lineX >= PAGESIZE.width - 60)
            {
                drawText(Coordinate{lastBottomLine + (PAGESIZE.width - lastBottomLine) / 2, PAGESIZE.height - 7.5}, PAGESIZE.sizeString.replace("_", " "), 3.5, TextHeightAnchor::Middle, TextWidthAnchor::Center, 0.35);
            }
...
void TemplateGenKiCAD_6::drawTitelblockISO7200()
{
    // Frame
...
void TemplateGenKiCAD_6::drawRevHistoryASME_Y14_35_Width180()
{
...
void TemplateGenKiCAD_6::drawFoldLines(double depth)
{
    switch (PAGESTYLE)
    {
    case PageStyle::ISO5457_ISO7200:
...
void TemplateGenKiCAD_6::drawSmallPartsList()
{
...
void TemplateGenKiCAD_6::drawFullSheetPartsList()
{
...
void TemplateGenKiCAD_6::drawLogoTitelblockISO7200()
{
    // Load SVG
...
void TemplateGenKiCAD_6::drawISO5457_ISO7200()
{
    if(TRIMMINGMARKS)
    {
...
TemplateGenKiCAD_6::TemplateGenKiCAD_6(QObject *parent) : QObject(parent)
{
}
...
const QString &TemplateGenKiCAD_6::getDIR() const
{
    return DIR;
}

void TemplateGenKiCAD_6::setDIR(const QString &newDIR)
{
    finisheD.diR = true;
    DIR = newDIR;
}

const PageSize &TemplateGenKiCAD_6::getPAGESIZE() const
{
    return PAGESIZE;
}

void TemplateGenKiCAD_6::setPAGESIZE(const PageSize &newPAGESIZE)
{
    finisheD.pagesizeE = true;
    PAGESIZE = newPAGESIZE;
}

PageStyle TemplateGenKiCAD_6::getPAGESTYLE() const
{
    return PAGESTYLE;
}

void TemplateGenKiCAD_6::setPAGESTYLE(PageStyle newPAGESTYLE)
{
    finisheD.pagestylE = true;
    PAGESTYLE = newPAGESTYLE;
}

qint64 TemplateGenKiCAD_6::getNUMOPTLINES() const
{
    return NUMOPTLINES;
}

void TemplateGenKiCAD_6::setNUMOPTLINES(qint64 newNUMOPTLINES)
{
    NUMOPTLINES = newNUMOPTLINES;
    finisheD.numoptlineS = true;
}

const QMap<QString, TitelblockField> &TemplateGenKiCAD_6::getTITELBLOCKFIELDS() const
{
    return TITELBLOCKFIELDS;
}

void TemplateGenKiCAD_6::setTITELBLOCKFIELDS(const QMap<QString, TitelblockField> &newTITELBLOCKFIELDS)
{
    TITELBLOCKFIELDS = newTITELBLOCKFIELDS;
    finisheD.titelblockfieldS = true;
}

bool TemplateGenKiCAD_6::getTRIMMINGMARKS() const
{
    return TRIMMINGMARKS;
}

void TemplateGenKiCAD_6::setTRIMMINGMARKS(bool newTRIMMINGMARKS)
{
    TRIMMINGMARKS = newTRIMMINGMARKS;
    finisheD.trimmingmarkS = true;
}

RevHistoryStyle TemplateGenKiCAD_6::getREVHISTORYSTYLE() const
{
    return REVHISTORYSTYLE;
}

void TemplateGenKiCAD_6::setREVHISTORYSTYLE(RevHistoryStyle newREVHISTORYSTYLE)
{
    REVHISTORYSTYLE = newREVHISTORYSTYLE;
    finisheD.revhistorystylE = true;
}

const QMap<QString, TitelblockField> &TemplateGenKiCAD_6::getREVHISTORYFIELDS() const
{
    return REVHISTORYFIELDS;
}

void TemplateGenKiCAD_6::setREVHISTORYFIELDS(const QMap<QString, TitelblockField> &newREVHISTORYFIELDS)
{
    REVHISTORYFIELDS = newREVHISTORYFIELDS;
    finisheD.revhistoryfieldS = true;
}

qint64 TemplateGenKiCAD_6::getNUMREVHISTORY() const
{
    return NUMREVHISTORY;
}

void TemplateGenKiCAD_6::setNUMREVHISTORY(qint64 newNUMREVHISTORY)
{
    NUMREVHISTORY = newNUMREVHISTORY;
    finisheD.numrevhistorY = true;
}

bool TemplateGenKiCAD_6::getREVHISTORY() const
{
    return REVHISTORY;
}

void TemplateGenKiCAD_6::setREVHISTORY(bool newREVHISTORY)
{
    REVHISTORY = newREVHISTORY;
    finisheD.revhistorY = true;
}

bool TemplateGenKiCAD_6::getFOLDLINES() const
{
    return FOLDLINES;
}

void TemplateGenKiCAD_6::setFOLDLINES(bool newFOLDLINES)
{
    FOLDLINES = newFOLDLINES;
    finisheD.foldlineS = true;
}

const PageSize &TemplateGenKiCAD_6::getFOLDLINETARGET() const
{
    return FOLDLINETARGET;
}

void TemplateGenKiCAD_6::setFOLDLINETARGET(const PageSize &newFOLDLINETARGET)
{
    FOLDLINETARGET = newFOLDLINETARGET;
    finisheD.foldlinestargeT = true;
}

quint64 TemplateGenKiCAD_6::getNUMPARTSSMALLPARTSLIST() const
{
    return NUMPARTSSMALLPARTSLIST;
}

void TemplateGenKiCAD_6::setNUMPARTSSMALLPARTSLIST(quint64 newNUMPARTSSMALLPARTSLIST)
{
    NUMPARTSSMALLPARTSLIST = newNUMPARTSSMALLPARTSLIST;
    finisheD.numpartssmallpartslisT = true;
}

bool TemplateGenKiCAD_6::getSMALLPARTSLIST() const
{
    return SMALLPARTSLIST;
}

void TemplateGenKiCAD_6::setSMALLPARTSLIST(bool newSMALLPARTSLIST)
{
    SMALLPARTSLIST = newSMALLPARTSLIST;
    finisheD.smallpartslisT = true;
}

quint64 TemplateGenKiCAD_6::getNUMLINESMALLPARTSLIST() const
{
    return NUMLINESMALLPARTSLIST;
}

void TemplateGenKiCAD_6::setNUMLINESMALLPARTSLIST(quint64 newNUMLINESMALLPARTSLIST)
{
    NUMLINESMALLPARTSLIST = newNUMLINESMALLPARTSLIST;
    finisheD.numlinessmallpartslisT = true;
}

const QMap<QString, TitelblockField> &TemplateGenKiCAD_6::getSMALLPARTSLISTFIELDS() const
{
    return SMALLPARTSLISTFIELDS;
}

void TemplateGenKiCAD_6::setSMALLPARTSLISTFIELDS(const QMap<QString, TitelblockField> &newSMALLPARTSLISTFIELDS)
{
    SMALLPARTSLISTFIELDS = newSMALLPARTSLISTFIELDS;
    finisheD.smallpartslistfieldS = true;
}

bool TemplateGenKiCAD_6::getFULLSHEETPARTSLIST() const
{
    return FULLSHEETPARTSLIST;
}

void TemplateGenKiCAD_6::setFULLSHEETPARTSLIST(bool newFULLSHEETPARTSLIST)
{
    FULLSHEETPARTSLIST = newFULLSHEETPARTSLIST;
    finisheD.fullsheetpartslisT = true;
}

quint64 TemplateGenKiCAD_6::getNUMLINESFULLSHEETPARTSLIST() const
{
    return NUMLINESFULLSHEETPARTSLIST;
}

void TemplateGenKiCAD_6::setNUMLINESFULLSHEETPARTSLIST(quint64 newNUMLINESFULLSHEETPARTSLIST)
{
    NUMLINESFULLSHEETPARTSLIST = newNUMLINESFULLSHEETPARTSLIST;
    finisheD.numlinesfullsheetpartslisT = true;
}

const QMap<QString, TitelblockField> &TemplateGenKiCAD_6::getFULLSHEETPARTSLISTFIELDS() const
{
    return FULLSHEETPARTSLISTFIELDS;
}

void TemplateGenKiCAD_6::setFULLSHEETPARTSLISTFIELDS(const QMap<QString, TitelblockField> &newFULLSHEETPARTSLISTFIELDS)
{
